 ...
 * 
 * 
 * queries[i] = [x, y]: Build an obstacle at coordinate (x, y) in the plane. It
 * is guaranteed that there is no obstacle at this coordinate when this query
 * is made.
 * 
 * 
 * After each query, you need to find the distance of the k^th nearest obstacle
 * from the origin.
 * 
 * Return an integer array results where results[i] denotes the k^th nearest
