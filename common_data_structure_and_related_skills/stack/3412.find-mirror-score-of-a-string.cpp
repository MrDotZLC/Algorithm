/*
 * @lc app=leetcode id=3412 lang=cpp
 *
 ...
 * At each index i, find the closest unmarked index j such that j < i and s[j]
 * is the mirror of s[i]. Then, mark both indices i and j, and add the value i
 * - j to the total score.
...
public:
    long long calculateScore(string s) {
        long long ans = 0;
        vector<vector<int>> sts(26, vector<int>());
